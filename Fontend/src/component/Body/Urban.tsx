            ...
            <div className="container">
                <div className={"top__flex-container"}>
                    <div className={"top__center-container"}>
                        <div className={"news-container"}>
                            <NewsMain title="Thời sự" url="https://nld.com.vn/rss/thoi-su/do-thi.rss" quantity={1}/>

                            <div className={"line-element"}></div>

                            <SmallNews title="" url="https://nld.com.vn/rss/thoi-su/do-thi.rss" quantity={3}/>
                        </div>
                    </div>
                </div>
                ...
                <div className={"bottom__flex-container"}>
                    <div className={"bottom__center-container"}>
                        <NewsList title="" url="https://nld.com.vn/rss/thoi-su/do-thi.rss" quantity={30}/>
                    </div>
